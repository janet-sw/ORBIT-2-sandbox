...
CHECKPOINT_PATH="/lustre/orion/csc662/proj-shared/janet/forecasting/orbit_main/era5_forecasting_1.40625_deg_bilinear_antialias=True/checkpoint_epoch_0029.pt"
